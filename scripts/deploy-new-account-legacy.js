...
async function deployAccount() {
    console.log('Deploying StarkNet Account (Legacy Mode)');
    console.log('=================================');
    ...
    try {
        ...
        // Create account instance (Starknet.js v8 syntax)
        ...
        // Deploy account with legacy transaction format to avoid l1_data_gas issue
        console.log('Sending deployment transaction with legacy format...');
        
        // Manually construct the deployment payload to avoid newer transaction formats
        const deployPayload = {
        ...
        const deployOptions = {
            ...
            version: 2 // Use version 2 to avoid newer transaction format issues
        };
        
        const deployResponse = await account.deployAccount(deployPayload, deployOptions);
