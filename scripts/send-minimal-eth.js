...
const { RpcProvider, Account, CallData, uint256 } = require('starknet');
const fs = require('fs');
const path = require('path');
const dotenv = require('dotenv');

console.log('Sending Minimal ETH Transfer to Deploy Account');
console.log('======================================');
...
// Send to a known address (we can send to ourselves or to a test address)
const recipientAddress = '0x01176a1bd84444c89232ec27754698e5d2e7e1a7f1539f12027f28b23ec9f3d8'; // The address you mentioned earlier
...
async function sendEth() {
    try {
        ...
        console.log(`\nPreparing to send minimal ETH to: ${recipientAddress}`);
