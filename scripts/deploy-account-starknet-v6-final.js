...
async function deployAccount() {
    console.log('Deploying StarkNet Account (Starknet.js v6 - Final)');
    console.log('==============================================');
    ...
    try {
        ...
        const deployResponse = await account.deployAccount({
            ...
            maxFee: 0n // Zero fee - Starknet.js v6 compatible
        });
        ...
        if (error.message.includes('maxFee') || error.message.includes('fee')) {
