...
async function deployAccount() {
    console.log('Deploying StarkNet Account (Starknet.js v8)');
    console.log('=====================================');
    ...
    try {
        ...
        // Deploy account with Starknet.js v8 compatible fee model
        ...
        const deployResponse = await account.deployAccount({
            ...
            maxFee: BigInt(1000000000000000) // 0.001 ETH - Compatible fee
        });
