...
import { Brain, Shield, Upload, Download, Play, X, CheckCircle, AlertCircle, FileText, Key, Database, Bot, Zap, Hash } from 'lucide-react';
...
import { ZtarknetDetails } from '../components/ZtarknetDetails';
import type { UnlearningResult } from '../lib/unlearning';
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          request_reason: reason || targetText.slice(0, 100) + '...',
              ...
              <div className="space-y-6">
                ...
                {assistantResults && (
                  <div className="bg-gray-700/30 rounded-xl p-6 border border-gray-600">
                    ...
                    {/* Ztarknet Details - will be populated after backend processing */}
                    {assistantResults.success && (
                      <div className="mt-4 p-4 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        ...
                        <p className="text-gray-400 text-sm">
                          After the backend service processes this request, Ztarknet transaction details will appear here.
                          The proof hash will be generated and anchored to the local Zcash blockchain.
                        </p>
                      </div>
                    )}
                  </div>
